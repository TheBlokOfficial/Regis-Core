...
- **Ascetyczny UX**: Ekran zarządzania i panel czatu dopracowano zgodnie z purystycznymi wytycznymi designu (`AGENTS.md`). Całość opiera się na inteligentnych pustych przestrzeniach (negative space) i spłaszczonych procesach (m.in. szybka opcja "Usuń" zintegrowana wprost do opcji edycyjnych profilu, brak kolorowych ramek w menu głównym).
